...
public class Main {
	public static void main(String[] args) {
		Predmet[] pr = { new Predmet("Matematika", "MAT1"), new Predmet("Informatika", "INF1"),
				new Predmet("Java", "JAV1"), new Predmet("ITBootCamp", "ITB1") };
		...
		Student[] students = { new Student("Petar Peric", "2704989456547", o1),
				new Student("Katarina Katic", "2704997956752", o2), new Student("Carli Caplin", "2704991456882", o3),
